// holo-efi  --  Holo EFI Chainloader

// SPDX-License-Identifier: GPL-2.0+
// Copyright © 2023,2025 Collabora Ltd
// Copyright © 2023,2025 Valve Corporation

// holo-efi is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
// the Free Software Foundation, either version 2.0 of the License, or
// (at your option) any later version.

// holo-efi is distributed in the hope that it will be useful,
...
VOID gfx_connect_controllers (VOID)
{
    ...
    if( EFI_ERROR( LibLocateHandle(AllHandles, NULL, NULL, &count, &handles) ) )
        return;

    DEBUG_LOG( "gfx_connect_controllers: connecting all %d handles", count );
